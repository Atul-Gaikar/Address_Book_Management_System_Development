...
public class AddressBookManagementMultipleUC6 {
	...
	public static void main(String[] args) {
		...
		List<AddressBookManagementMultipleUC6> persons = new ArrayList<>();
		...
		if (userChoice == 0) {
			...
			for (int i = 0; i < noOfPersons; i++) {
				AddressBookManagementMultipleUC6 contact = new AddressBookManagementMultipleUC6();
			...
			if (userChoice2 == 0) {
				...
				for (AddressBookManagementMultipleUC6 i : persons) {
